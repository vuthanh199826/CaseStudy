...
public class UserController extends HttpServlet {
    ...
    private void showFormUpdate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("/formAdmin/update.jsp");
    ...
    private void showFormCreate(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        RequestDispatcher dispatcher = req.getRequestDispatcher("/formAdmin/signUp.jsp");
        List<User> list = userDAO.findAll();
        req.setAttribute("list", list);
        dispatcher.forward(req, resp);
    }
    private void showAll(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        RequestDispatcher dispatcher = req.getRequestDispatcher("/formAdmin/listAdmin.jsp");
        List<User> list = userDAO.findAll();
